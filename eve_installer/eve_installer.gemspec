...
require "eve_installer/version"

Gem::Specification.new do |spec|
  spec.name    = "eve_installer"
  spec.license = "MIT"
  spec.version = EveInstaller::VERSION
  spec.authors = ["Taylor-Jayde Blackstone"]
  spec.email   = ["t.blackstone@inspyre.tech"]

  spec.summary     = %q{Assists with the cloning, installation, and update of EveIRC 6.9 and above}
  spec.description = %q{Use this program as the main installation, configuration, and update solution EveIRC}
  spec.homepage    = "https://inspyre.tech/EveIRC"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/Inspyre-Technologies/EveIRC"
    spec.metadata["changelog_uri"]   = spec.metadata['source_code_uri'] + "PATCHNOTES.md"
  else
