    ...
    class PluginsFirstRun
      ...
      def core_plugins
        ...
        open('config/settings/plugins.rb', 'a') {|f|
          ...
          f.puts "require_relative '../../plugins/core/bot_control'"
          f.puts "require_relative '../../plugins/core/channel_control'"
          f.puts "require_relative '../../plugins/core/update'"
        }
        ...
        open('config/settings/constants.rb', 'a') {|f|
          ...
          f.puts "Cinch::Plugins::BotControl"
          f.puts "Cinch::Plugins::ChannelControl"
          f.puts "Cinch::Plugins::Update"
        }
